...
const LandingSection = () => {
	...
	<div className="pad display">
		...
		fontWeight: "bold",
		color: "#2c3e50",
		}}>Software and Automation Engineer || IT Support || Frontend and Backend Deveoper || DevOps || Software Designer || Customer Service Engineer || ATM Engineer || Data Analyst || Technical Engineer #4</h3>
		</div>
	</div>
